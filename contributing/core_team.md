...
Spree has a core team of contributors whose members work together to maintain the source code and provide support to the Spree community. Individuals are invited to join the core team based on the volume and quality of the code contributed to the project as well as their sustained efforts in improving the overall quality of the Spree community.

There are over six hundred different contributors to the Spree project. The core team is essential in maintaining order as well as helping to run the growing infrastructure required for the project.

## Active Members

{% for member in site.active_members %}
  **{{member.name}}**
  {{member.bio}}
